        ...
        f.ensureModuleRegistered("SignalsPixelEndpoint", function () {
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    function o(a) {
                        var b = a.customData, c = a.customParams, d = a.eventName, e = a.id;
                        a = a.piiTranslator;
                        a = new j(a);
                        a.append("id", e);
                        a.append("ev", d);
                    ...
                    function r(a) {
                        var f = a.customData, g = a.customParams, h = a.eventName;
                        a = o(a);
                        var i = d.get();
                        if (i != null) {
            ...
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    k.exports = new c(function (b, c) {
                        ...
                        function b(a) {
                            var b = a.data, d = b.graphToken, e = b.msg_type, f = b.pixelID;
            ...
            return function (g, h, j, d) {
                ...
                (function () {
                    ...
                    var a = Object.assign || function (a) {
                        ...
                        d = f.getFbeventsModules("SignalsFBEventsEvents"), h = d.configLoaded,
                    ...
                    var n = f.getFbeventsModules("SignalsFBEventsOptIn"),
                        ...
                        p = f.getFbeventsModules("SignalsPixelEndpoint"), q = o.each, r = o.keys, s = o.map, t = o.some,
                        u = d.logError, v = d.logUserError, w = {
                            AutomaticMatching: !0,
            ...
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    c = function c() {
                        ...
                        this._sendXHRPost = function (b, c, d) {
                            b.replaceEntry("rqm", "xhrPOST");
                            var e = new XMLHttpRequest(), g = function () {
                                if (d != null) {
                            ...
                            if ("withCredentials" in e) e.withCredentials = !0, e.open("POST", c, !1), e.onreadystatechange = function () {
                                ...
                                e.status !== 200 && g()
                            }; else if (XDomainRequest != void 0) e = new XDomainRequest(), e.open("POST", c), e.onerror = g; else return !1;
                            e.send(b.toFormData());
                            return !0
                        };
        ...
        f.ensureModuleRegistered("SignalsFBEventsPluginManager", function () {
            return function (g, j, k, d) {
                ...
                (function () {
                    ...
                    b = f.getFbeventsModules("SignalsFBEventsLogging");
                    var g = b.logError, j = f.getFbeventsModules("SignalsFBEventsPlugin");
            ...
            return function (g, h, i, l) {
                ...
                (function () {
                    ...
                    var b = a.getFbeventsModules("SignalsFBEventsQE"), c = a.getFbeventsModules("SignalsParamList"),
                        ...
                        y = a.getFbeventsModules("SignalsFBEventsEvents"), z = m.each, A = m.FBSet, B = m.isEmptyObject,
                        C = m.isNumber, D = m.keys;
                    m = y.execEnd;
                    var E = y.fired, F = y.getCustomParameters, aa = y.iwlBootstrap, ba = y.piiInvalidated,
                        ca = y.setIWLExtractors, da = n.logError, G = n.logUserError, H = r.global, I = -1,
                        ea = Array.prototype.slice, J = Object.prototype.hasOwnProperty, K = i.href, L = !1, M = !1,
                        N = [], O = {}, P;
                    h.referrer;
                    var Q = {PageView: new A(), PixelInitialized: new A()}, R = new p(a, O), S = new w(R, H);
                    ...
                    function T() {
                        try {
                            ...
                            var c = v(b), d = [].concat(k(c.args)), e = c.isLegacySyntax, f = d.shift();
                            switch (f) {
                                case"addPixelId":
                                    L = !0;
                                    V.apply(this, d);
                                ...
                                case"send":
                                    ...
                                    break;
                                case"on":
                                    var g = j(d), h = g[0], i = g.slice(1), l = y[h];
                                    l && l.triggerWeakly(i);
                                    break;
                                case"loadPlugin":
                                    S.loadPlugin(d[0]);
                    ...
                    function U(c) {
                        ...
                        switch (c) {
                            ...
                            case"firstPartyCookies":
                                ...
                                if (typeof p === "string") R.callMethod([r, p, "FirstPartyCookies"]); else if (p === void 0) R.disableFirstPartyCookies = !0; else throw new Error("Invalid pixelID supplied to set cookie controls.");
                                break;
                            case"experiments":
                                var t = f[0], u = [], v = D(t);
                            ...
                            case"iwlExtractors":
                                var z = f[0], A = f[1];
                                ca.triggerWeakly({extractors: A, pixelID: z});
                                break;
                            case"startIWLBootstrap":
                                var B = f[0], C = f[1];
                                aa.triggerWeakly({graphToken: B, pixelID: C});
                                break;
                            default:
                                var E = f[0], F = f[1];
                    ...
                    function ga(a, b, c) {
                        ...
                        if (J.call(O, c)) {
                            for (var d = 0, e = N.length; d < e; d++) if (N[d].id === c) {
                                N[d][a] = b;
                                break
                            }
                        } else G({metadataValue: b, pixelID: c, type: "SET_METADATA_ON_UNINITIALIZED_PIXEL_ID"})
                    }
                    ...
                    (L && M || g.fbq !== g._fbq) && G({type: "CONFLICTING_VERSIONS"});
                    N.length > 1 && G({type: "MULTIPLE_PIXELS"});
