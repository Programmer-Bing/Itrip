!function t(e, r, i) {
    ...
    1: [function (t, e, r) {
        ...
        if ("undefined" == typeof w) {
            var y = Object.defineProperty, b = Date.now() % 1e9;
            w = function () {
        ...
        var _ = new w, S = window.msSetImmediate;
        if (!S) {
            var C = [], O = String(Math.random());
        ...
        v.prototype = {
            enqueue: function (t) {
                ...
                this.transientObservedNodes = [], t.forEach(function (t) {
                    ...
                    for (var e = _.get(t), r = 0; r < e.length; r++) if (e[r] === this) {
                        e.splice(r, 1);
                        break
                    }
                }, this)
                ...
                switch (t.stopImmediatePropagation(), t.type) {
                    case"DOMAttrModified":
                        var e = t.attrName, r = t.relatedNode.namespaceURI, i = t.target, n = new h("attributes", i);
                    ...
                    case"DOMCharacterDataModified":
                        var i = t.target, n = h("characterData", i), o = t.prevValue;
                        a(i, function (t) {
                    ...
                    case"DOMNodeInserted":
                        ...
                        var d = c.previousSibling, f = c.nextSibling, n = h("childList", i);
        ...
        d = t("../core/tools/utils"), i = t("../core/dimensions/app_dimension"), s = t("../core/dimensions/page_dimension"), o = t("../core/dimensions/evar_dimension"), a = t("../core/dimensions/people_dimension"), u = t("../core/dimensions/system_dimension"), c = t("../core/dimensions/visitor_dimension"), n = function () {
            ...
            return t.prototype.version = "2.1.27", t.prototype.circleHost = ("https:" === document.location.protocol ? "https://" : "http://") + "www.growingio.com", t.prototype.endpoint = "/events", e = ["page", "vst", "clck", "imp", "chng", "sbmt", "cstm", "pvar", "evar", "ppl", "reengage", "vstr"], t.prototype.defaultOptions = {
                ...
                return this.beforeConnect(), this.setGioIdByTouch(), this.sender.connect({isBot: !!this.options.isBot})
        ...
        n = t("./base_dimension"), i = function (t) {
            ...
            return s(e, t), e.prototype.set = function (t) {
                ...
                if (2 === arguments.length && this.utils.isString(arguments[0]) && 0 !== arguments[0].trim().length) e = {}, e[arguments[0]] = arguments[1], t = e; else if (1 !== arguments.length || !this.utils.isObject(arguments[0]) || this.utils.isEmptyObject(arguments[0])) return;
                ...
                return this.lastSetTimeout && clearTimeout(this.lastSetTimeout), this.lastSetTimeout = setTimeout(function (t) {
                    return function () {
                        return t.observer.setDeferWithPage({"var": t.app_cache}, t.defer_condition)
                    }
                }(this), 0)
    ...
    }, {"./base_dimension": 4}], 4: [function (t, e, r) {
        var i, n;
    ...
    }, {"../tools/utils": 18}], 5: [function (t, e, r) {
        ...
        i = t("./base_dimension"), o = t("../tools/utils"), n = function (t) {
            ...
            return a(e, t), e.prototype.set = function (t) {
                ...
                if (1 === arguments.length && this.utils.isObject(arguments[0]) && !this.utils.isEmptyObject(arguments[0])) ; else {
    ...
    }, {"../tools/utils": 18, "./base_dimension": 4}], 6: [function (t, e, r) {
        var i, n, o, s = function (t, e) {
            return function () {
                return t.apply(e, arguments)
            }
    ...
    }, {"../tools/utils": 18, "./base_dimension": 4}], 7: [function (t, e, r) {
        var i, n, o, s = function (t, e) {
            return function () {
                return t.apply(e, arguments)
            }
        ...
        i = t("./base_dimension"), o = t("../tools/utils"), n = function (t) {
            ...
            return a(e, t), e.prototype.set = function (t) {
                ...
                if (arguments.length > 1 && this.utils.isString(arguments[0]) && 0 !== arguments[0].trim().length) e = {}, e[arguments[0].trim()] = arguments[1], t = e; else if (!this.utils.isObject(arguments[0]) || this.utils.isEmptyObject(arguments[0])) return;
    ...
    }, {"../tools/utils": 18, "./base_dimension": 4}], 8: [function (t, e, r) {
        var i, n, o, s = function (t, e) {
            return function () {
                return t.apply(e, arguments)
            }
    ...
    }, {"../tools/utils": 18, "./base_dimension": 4}], 9: [function (t, e, r) {
        var i, n, o, s = function (t, e) {
            return function () {
                return t.apply(e, arguments)
            }
    ...
    }, {"../tools/utils": 18, "./base_dimension": 4}], 10: [function (t, e, r) {
        var i, n, o, s, a, u;
        u = t("../tools/utils"), n = t("./tagging_node_info"), s = ["I", "SPAN", "EM", "svg"], o = ["TR", "LI", "DL"], a = ["A", "BUTTON"], i = function () {
            ...
            return t.prototype.path = function (t, e) {
                ...
                if (null == e && (e = !1), s = "", g = !1, i = {}, p = !1, l = !1, _ = void 0, c = 0, b = [], o = [], t === document) return {isIgnore: !0};
                if (t.tagName) {
                ...
                if (s) for (a = s.parentNode, r = 1, c = a.childNodes, e = 0, i = c.length; i > e; e++) if (n = c[e], n.tagName === s.tagName) {
                    if (u.hasAttr(n, "data-growing-idx") && (r = parseInt(n.getAttribute("data-growing-idx"))), n === s) return r;
                    r += 1
                }
            }, t.prototype.isLeaf = function (t) {
                var e, r, i, n;
                if (t.hasChildNodes() && "svg" !== t.tagName) for (n = t.childNodes, r = 0, i = n.length; i > r; r++) if (e = n[r], 1 === e.nodeType) return !1;
                return !0
            }, t.prototype.isParentOfLeaf = function (t) {
                var e, r, i, n;
                if (!t.childNodes) return !1;
                if ("svg" === t.tagName) return !1;
                for (n = t.childNodes, r = 0, i = n.length; i > r; r++) if (e = n[r], !this.isLeaf(e)) return !1;
                return !0
            }, t.prototype.depthInside = function (t, e, r) {
                var i, n, o, s;
                if (null == r && (r = 1), t.hasChildNodes()) {
                    if (r > e) return !1;
                    for (s = t.childNodes, i = 0, n = s.length; n > i; i++) if (o = s[i], 1 === o.nodeType && !this.depthInside(o, e, r + 1)) return !1
                }
                return e >= r
            }, t.prototype.onlyContainsChildren = function (t, e) {
                var r, i, n, o;
                if (0 === !t.children.length) return !1;
                for (o = t.children, i = 0, n = o.length; n > i; i++) if (r = o[i], -1 === u.indexOf(e, r.tagName)) return !1;
                return !0
    ...
    }, {"../tools/utils": 18, "./tagging_node_info": 12}], 11: [function (t, e, r) {
        var i, n, o, s;
    ...
    }, {"../tools/guid": 16, "../tools/utils": 18, "../vendor/cookie": 19}], 12: [function (t, e, r) {
        var i, n, o, s;
        s = t("../tools/utils"), o = s.detectIE() || 0 / 0, n = /(^| )(clear|clearfix|active|hover|enabled|hidden|display|focus|disabled|ng-|growing-)[^\. ]*/g, i = function () {
            ...
            return t.prototype.path = function () {
                var t, e, r, i, n;
                if (i = "/" + this.name, null != this.id && (i += "#" + this.id), null != this.klass) for (n = this.klass, t = 0, r = n.length; r > t; t++) e = n[t], i += "." + e;
                return i
    ...
    }, {"../tools/utils": 18}], 13: [function (t, e, r) {
        ...
        u = t("../tools/utils"), s = u.detectIE() || 0 / 0, a = u.detectIOS() || 0 / 0, 9 >= s && t("json2"), n = t("./messaging_observer"), o = t("../page_service"), i = function () {
            ...
            return i = null, b = 3, h = [], s = {}, C = {
                ...
                return this.pageService.setPageGroup(t, function (e) {
                    return function (r) {
                        var i;
                        return e.sendPageCallback(r), null != (i = e.messagingObserver) ? i.sendPageLoad({pg: t}) : void 0
                    }
                }(this))
                ...
                if (c = [], f = !0, t.leaf) 1 === t.nodeType && ((null != (g = t.attributes) ? g.href : void 0) || null != t.text || null != t.obj) && (p = this.nodeMessage(t, !0), e > 1 && (p.idx = t.idx), c.push(p)); else if (t.isContainer && (p = this.nodeMessage(t, !0), c.push(p)), 0 === t.childNodes.length && -1 === u.indexOf(y, t.tagName)) ; else {
                    ...
                    if ((-1 !== u.indexOf(v, t.tagName) || f && ((null != (w = t.attributes) ? w.any : void 0) || t.text)) && (t.text || (n = t.dom, t.text = n ? this.info.containerElemContent(n) : u.parentOfLeafText(t)), p = this.nodeMessage(t, !1), c.push(p)), "SPAN" === t.tagName) for (b = t.childNodes, s = 0, h = b.length; h > s; s++) if (i = b[s], "svg" === i.tagName) for (_ = i.childNodes, a = 0, l = _.length; l > a; a++) r = _[a], 1 === r.nodeType && "use" === r.tagName && u.hasAttr(r, "xlink:href") && (t.text = r.getAttribute("xlink:href"), p = this.nodeMessage(t, !1), c.push(p))
                }
                return c
                ...
                a = {
                    ...
                    return t.which > 1 || (_ = +Date.now(), l === _) ? void 0 : (l = _, p = {
                        ...
                        return t = {target: p.target, type: "click"}, s(t)
                    }, 100))
                }, d = function (t) {
                    var e;
                    return e = {
                ...
                if (i = {}, O = e.tagName, "IMG" === O ? (null != (_ = e.src) ? _.length : void 0) > 0 && -1 === e.src.indexOf("data:image") && (i.h = e.src) : u.hasAttr(e, "href") && (n = e.getAttribute("href"), n && 0 !== n.indexOf("javascript") && (i.h = u.normalizePath(n.slice(0, 320)))), u.hasAttr(e, "data-growing-title") && e.getAttribute("data-growing-title").length > 0) i.v = e.getAttribute("data-growing-title"); else if (u.hasAttr(e, "title") && e.getAttribute("title").length > 0) i.v = u.processText(e.getAttribute("title")); else if ("click" === t) if (this.info.isLeaf(e)) if ("IMG" === O) e.alt ? i.v = e.alt : i.h && (a = i.h.split("?")[0], s = a.split("/"), s.length > 0 && (i.v = s[s.length - 1])); else if ("INPUT" === O && -1 !== u.indexOf(w, e.type)) i.v = u.processText(e.value); else if ("svg" === O) for (S = e.childNodes, o = 0, y = S.length; y > o; o++) r = S[o], 1 === r.nodeType && "use" === r.tagName && u.hasAttr(r, "xlink:href") && (i.v = r.getAttribute("xlink:href")); else I = "", null != e.textContent ? I = e.textContent.replace(/[\n \t]+/g, " ").trim() : null != e.innerText && (I = e.innerText.replace(/[\n \t]+/g, " ").trim()), I.length > 0 && (I.length < 50 ? i.v = u.processText(I) : "A" === O && (i.v = u.processText(I.slice(0, 50)))); else -1 !== u.indexOf(v, O) ? i.v = this.info.containerElemContent(e) : this.info.isParentOfLeaf(e) && (i.v = u.parentOfLeafText(e)); else if ("change" === t) "TEXTAREA" !== O && ("INPUT" === O ? -1 !== u.indexOf(f, e.type) ? (i.v = u.processText(e.value), h = e.parentNode, "LABEL" === h.tagName ? d = h : "BODY" !== h.tagName && (h = h.parentNode, "LABEL" === h.tagName ? d = h : e.id && (m = h.getElementsByTagName("label"), function () {
                    var t, r, i;
                    for (i = [], t = 0, r = m.length; r > t; t++) g = m[t], i.push(g["for"] === e.id);
                    return i
                }() && (d = g))), null != d && (l = this.info.containerElemContent(d), (null != l ? l.length : void 0) > 0 && (i.obj = l + " (" + e.checked + ")"))) : "password" !== e.type && (u.hasAttr(e, "growing-track") || u.hasAttr(e, "data-growing-track")) && (i.v = u.processText(e.value)) : "SELECT" === O && (i.v = u.processText(e.value), 1 === e.selectedOptions.length && null != e.selectedOptions[0].label && (i.obj = e.selectedOptions[0].label))); else if ("submit" === t) for (C = e.getElementsByTagName("input"), p = 0, b = C.length; b > p; p++) c = C[p], ("search" === c.type || "text" === c.type && ("q" === c.id || -1 !== c.id.indexOf("search") || -1 !== c.className.indexOf("search") || "q" === c.name || -1 !== c.name.indexOf("search"))) && (i.x = this.info.path(c).xpath, i.v = u.processText(c.value.trim()));
                return i
                ...
                var e, r, i, n, o, s, a, u;
                for (this.pluginLoaded = !1, a = document.getElementsByTagName("script"), n = 0, o = a.length; o > n; n++) if (i = a[n], u = i.getAttribute("src"), null != u && -1 !== u.indexOf("/outer-circle-plugin.js")) {
                    this.pluginLoaded = !0;
                    break
                }
                ...
                return u.bind(window, "load", function (t) {
                    ...
                    return function (e) {
                        var r, i;
                        if (t.queueTimeout && t.sendQueue(), i = +Date.now(), window.grWaitTime) for (r = i + 50; r > i;) i = +Date.now()
                    }
    ...
    }, {"../page_service": 15, "../tools/utils": 18, "./messaging_observer": 14, json2: 20}], 14: [function (t, e, r) {
        ...
        s = t("../tools/utils"), o = ["load-plugin", "circle-mode", "browse-mode"], n = ["load-plugin", "register-iframe", "circle-mode", "browse-mode", "page-load", "circle-load"], i = function () {
            ...
            return t.prototype.bindEvents = function () {
                return s.bind(window, "message", function (t) {
                    return function (e) {
                        ...
                        if (r = e.data, r.ai === window.vds.accountId && (i = r.mode || r.circleMode, t.isSdkEvent(i) && (!r.fsna || "sdk" === r.fsna))) {
                            ...
                            if (n = r.mode, u.call(o, n) >= 0) s.spreadToInnerIframes(r); else if (r.tna !== window.grSource.name && r.tna && r.tid && s.isSpreadPostMessage()) return void s.spreadToInnerIframes(r);
                ...
                var t, e, r, i, n, o, a, u;
                for (this.pluginLoaded = !1, t = s.getCirclePluginFileName(window._gr_support_circle_pop_out), a = document.getElementsByTagName("script"), n = 0, o = a.length; o > n; n++) if (i = a[n], u = i.getAttribute("src"), null != u && -1 !== u.indexOf("/" + t + ".js")) {
                    this.pluginLoaded = !0;
                    break
                }
                ...
                var t, e, r, i, n, o;
                if (t = s.getCirclePluginFileName(window._gr_support_circle_pop_out), !this.pluginLoaded) for (n = document.getElementsByTagName("script"), r = 0, i = n.length; i > r; r++) if (e = n[r], o = e.getAttribute("src"), null != o && -1 !== o.indexOf("/" + t + ".js")) {
                    this.pluginLoaded = !0;
                    break
                }
    ...
    }, {"../tools/utils": 18}], 15: [function (t, e, r) {
        var i, n;
        n = t("./tools/utils"), i = function () {
            function t(t, e, r) {
            ...
            return t.prototype.replaceProps = function (t) {
                ...
                if (this.messages = [], this.options = this.defaultOptions, t) for (i in t) this.options[i] = t[i];
                if (this.options.addPreProps || this.options.gioId) for (i in this.preProperties) null == (r = this.properties)[i] && (r[i] = this.preProperties[i]);
                ...
                return t ? (this.reduceProps({pg: t}), this.pageLoaded && +Date.now() - this.pageLoaded < 4e3 && this.launcher.started ? setTimeout(function (t) {
                    return function () {
                        return t.sendPV({sendVisit: !1, addPreProps: !0, useNewTime: !1}, e)
                    }
                ...
                }, n.query().length > 0 && (r.q = n.query()), t = this.gruser.getCs1(), t && (r.cs1 = t), window.gio && (r.appId = window.vds.appId), this.properties) for (e in this.properties) r[e] = this.properties[e];
                return r
    ...
    }, {"./tools/utils": 18}], 16: [function (t, e, r) {
        var i;
        i = function () {
            var t;
        ...
        o = t("./guid"), i = t("./local_store"), n = t("../vendor/cookie"), s = {
            bind: function (t, e, r, i) {
                ...
                for (i = t.length, r = -1; ++r < i;) if (n = t[r], n === e) return r;
                return -1
            }, detectIOS: function () {
                ...
                var e, r, i, n;
                if (i = null, null != t) for (r in t) if (n = t[r], null == i && (i = {}), e = r.length <= 50 ? r : r.slice(0, 50), null != n && "string" == typeof n && n.constructor === String && (n = n.length <= 1e3 ? n : n.slice(0, 1e3)), i[e] = n, this.getOwnPropertyNames(i).length >= 100) return i;
                return i
    ...
    }, {"../vendor/cookie": 19, "./guid": 16, "./local_store": 17}], 19: [function (t, e, r) {
        var i = /^(\.br\.|\.co\.|\.com\.|\.org\.|\.edu\.|\.net\.)/, n = {
            getItem: function (t) {
            ...
            getItem: n.getItem, hasItem: n.hasItem, keys: n.keys, setItem: function (t, e, r, o, s, a) {
                for (var u = 0; u < s.length; u++) if (!i.test(s[u])) {
                    n.setItem(t, e, r, o, s[u], a);
                    break
                }
            }, removeItem: function (t, e, r) {
                for (var o = 0; o < r.length; o++) if (!i.test(r[o])) {
        ...
        "object" != typeof JSON && (JSON = {}), function () {
            ...
            function str(t, e) {
                ...
                switch (u && "object" == typeof u && "function" == typeof u.toJSON && (u = u.toJSON(t)), "function" == typeof rep && (u = rep.call(e, t, u)), typeof u) {
                    ...
                    case"object":
                        ...
                        if (rep && "object" == typeof rep) for (o = rep.length, r = 0; o > r; r += 1) "string" == typeof rep[r] && (i = rep[r], n = str(i, u), n && s.push(quote(i) + (gap ? ": " : ":") + n)); else for (i in u) Object.prototype.hasOwnProperty.call(u, i) && (n = str(i, u), n && s.push(quote(i) + (gap ? ": " : ":") + n));
                        return n = 0 === s.length ? "{}" : gap ? "{\n" + gap + s.join(",\n" + gap) + "\n" + a + "}" : "{" + s.join(",") + "}", gap = a, n
                }
            }
            ...
            "function" != typeof JSON.stringify && (meta = {
                ...
                var i;
                if (gap = "", indent = "", "number" == typeof r) for (i = 0; r > i; i += 1) indent += " "; else "string" == typeof r && (indent = r);
                if (rep = e, e && "function" != typeof e && ("object" != typeof e || "number" != typeof e.length)) throw new Error("JSON.stringify");
                return str("", {"": t})
            }), "function" != typeof JSON.parse && (JSON.parse = function (text, reviver) {
                function walk(t, e) {
                    var r, i, n = t[e];
                    if (n && "object" == typeof n) for (r in n) Object.prototype.hasOwnProperty.call(n, r) && (i = walk(n, r), void 0 !== i ? n[r] = i : delete n[r]);
        ...
        var i = function () {
            var t = String.fromCharCode, e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$", r = {
                compressToUTF16: function (e) {
                    ...
                    for (o = 0; o < t.length; o += 1) if (u = t.charAt(o), Object.prototype.hasOwnProperty.call(s, u) || (s[u] = l++, a[u] = !0), c = d + u, Object.prototype.hasOwnProperty.call(s, c)) d = c; else {
                        ...
                        } else for (n = s[d], i = 0; p > i; i++) g = g << 1 | 1 & n, v == e - 1 ? (v = 0, f.push(r(g)), g = 0) : v++, n >>= 1;
        ...
        var h = function () {
            ...
            return t.prototype.processMutations = function () {
                ...
                if (!this.visited.has(t)) {
                    ...
                    var r = this.treeChanges.get(t), i = e;
                    if ((r && r.childList || void 0 == i) && (i = this.treeChanges.reachabilityChange(t)), i !== c.STAYED_OUT) {
                        if (this.matchabilityChange(t), i === c.ENTERED) this.entered.push(t); else if (i === c.EXITED) this.exited.push(t), this.ensureHasOldPreviousSiblingIfNeeded(t); else if (i === c.STAYED_IN) {
                            var n = c.STAYED_IN;
                        ...
                        if (i !== c.STAYED_IN) for (var o = t.firstChild; o; o = o.nextSibling) this.visitNode(o, i)
                    }
                }
                ...
                for (var i = 0; i < this.entered.length; i++) {
                    var n = this.entered[i], o = this.matchabilityChange(n);
                    (o === c.ENTERED || o === c.STAYED_IN) && t.added.push(n)
                }
                for (var s = this.stayedIn.keys(), i = 0; i < s.length; i++) {
                    var n = s[i], o = this.matchabilityChange(n);
                    if (o === c.ENTERED) t.added.push(n); else if (o === c.EXITED) t.removed.push(n); else if (o === c.STAYED_IN && (t.reparented || t.reordered)) {
                ...
                for (var i = 0; i < this.exited.length; i++) {
                    var n = this.exited[i], o = this.matchabilityChange(n);
                ...
                for (var o = {}, s = this.treeChanges.keys(), i = 0; i < s.length; i++) {
                    var a = s[i], u = this.treeChanges.get(a);
                    if (u.attributes && c.STAYED_IN === this.treeChanges.reachabilityChange(a) && c.STAYED_IN === this.matchabilityChange(a)) for (var d = a, h = u.getAttributeNamesMutated(), l = 0; l < h.length; l++) {
                        var n = h[l];
                ...
                var r = this.matchCache[t.uid], i = r.get(e);
            ...
            function t(t, e) {
                ...
                if (this.projection = t, this.added = [], this.removed = [], this.reparented = e.all || e.element || e.characterData ? [] : void 0, this.reordered = e.all ? [] : void 0, t.getChanged(this, e.elementFilter, e.characterData), e.all || e.attribute || e.attributeList) {
                    var i = e.attribute ? [e.attribute] : e.attributeList, n = t.attributeChangedNodes(i);
            ...
            return Object.defineProperty(t.prototype, "caseInsensitiveTagName", {
                ...
                var i = e, n = i.parentNode || i.document, o = -1;
                ...
                for (var n = [], o = !1, s = 0; s < this.qualifiers.length; s++) {
                    var a = this.qualifiers[s], u = e.getAttributeOldValue(a.attrName);
                    n.push(u), o = o || void 0 !== u
                }
                if (!o) return r;
                for (var s = 0; s < this.qualifiers.length; s++) {
                    var a = this.qualifiers[s], u = n[s];
        ...
        }(), b = /^([a-zA-Z:_]+[a-zA-Z0-9_\-:\.]*)$/, _ = function () {
            function t(e) {
                var r = this;
            ...
            return t.createObserverOptions = function (t) {
                ...
                for (var i = {
                    ...
                    if (a.all) {
                        ...
                        var c = 0, d = Object.keys(a);
                        d.forEach(function (t) {
                            a.hasOwnProperty(t) && c++
                        });
                        var u = {element: a.element, elementFilter: y.parseSelectors(a.element)};
                ...
                return t.some(function (t) {
                    ...
                    if (t.attributeChanged) {
                        var r = Object.keys(t.attributeChanged), i = r.some(function (e) {
        ...
        var i = {
            ...
            s = ["button", "submit"], a = ["I", "SPAN", "EM", "svg"], u = ["A", "BUTTON"], c = function () {
                function t(t, e, r) {
                    if (t) {
                        var i = this;
                        ...
                        var a = [{element: "*"}, {element: "*", elementAttributes: "data-growing-title src"}];
                ...
                return t.prototype.disconnect = function () {
                    ...
                    if (void 0 === e) {
                        ...
                        for (var d = t.parentElement; d && "BODY" !== d.tagName && "HTML" !== d.tagName;) {
                            var h = "/" + d.tagName.toLowerCase(), l = d.getAttribute("id");
                            if (l && null === l.match(/^[0-9]/) && (h += "#" + l), d.hasAttribute("class")) for (var p = d.getAttribute("class").trim().split(/\s+/).sort(), f = 0; f < p.length; f++) p[f].length > 0 && null === o.exec(p[f]) && (h += "." + p[f]);
                    ...
                    switch (1 === g.nodeType && -1 !== u.indexOf(t.tagName) && (g.dom = t), g.nodeType) {
                        ...
                        case 1:
                            ...
                            var w = t;
                            if (g.tagName = w.tagName, g.attributes = {any: w.hasAttributes()}, this.appendDataAttrs(g, w), e += w.tagName.toLowerCase(), w.hasAttribute("id") && null === w.getAttribute("id").match(/^[0-9]/) && (e += "#" + w.getAttribute("id")), "INPUT" == w.tagName && w.hasAttribute("name")) e += "." + w.getAttribute("name"); else if (w.hasAttribute("class")) {
                            ...
                            if (e += "/", w.childNodes.length > 0) {
                                ...
                                if (O) for (var I = w.firstChild; I; I = I.nextSibling) if (1 === I.nodeType && -1 === a.indexOf(I.tagName)) {
                                    O = !1;
                                    break
                                }
                                for (var N = w.firstChild; N; N = N.nextSibling) {
                                    if (_ = w.hasAttribute("data-growing-info") ? w.getAttribute("data-growing-info") : null, S = w.hasAttribute("data-growing-idx") ? parseInt(w.getAttribute("data-growing-idx")) : -1, 1 === N.nodeType) {
                                        ...
                                        if (O && -1 !== a.indexOf(N.tagName) && (b = !1, !N.children || 0 === N.children.length)) continue;
                                        -1 !== n.indexOf(N.tagName) && (C += 1, S = C), N.hasAttribute("data-growing-idx") && (C = parseInt(N.getAttribute("data-growing-idx")), S = C), N.hasAttribute("data-growing-info") && (_ = N.getAttribute("data-growing-info"))
                                    }
                                    var x = this.serializeNode(N, e, C > 0 && S > 0 ? C : r, _ || c);
                                    if (null === x) 3 != N.nodeType && (b = !1);
                                    else if ("undefined" != typeof x.childNodes) {
                                        b = !1, y = !0;
                                        for (var E = 0; E < x.childNodes.length; E++) if (x.childNodes[E].tagName) {
                                            y = !1;
                                            break
                                        }
                            ...
                            if (b) if (g.leaf = !0, "IMG" === w.tagName && (delete g.attributes.href, w.src && -1 === w.src.indexOf("data:image") && (g.attributes.href = w.src)), w.hasAttribute("data-growing-title") && w.getAttribute("data-growing-title").length > 0) g.text = w.getAttribute("data-growing-title"); else if (w.hasAttribute("title") && w.getAttribute("title").length > 0) g.text = w.getAttribute("title"); else if ("IMG" === w.tagName) {
                            ...
                            } else if ("INPUT" === w.tagName && -1 !== s.indexOf(w.type)) g.text = w.value; else if ("svg" === w.tagName) {
                                for (var A = w.firstChild; A; A = A.nextSibling) if ("use" === A.tagName && A.getAttribute("xlink:href")) {
                                ...
                                if (w.hasAttribute("data-growing-title") && w.getAttribute("data-growing-title").length > 0) g.text = w.getAttribute("data-growing-title"); else if (w.hasAttribute("title") && w.getAttribute("title").length > 0) g.text = w.getAttribute("title"); else if ("svg" === w.tagName) for (var A = w.firstChild; A; A = A.nextSibling) if ("use" === A.tagName && A.getAttribute("xlink:href")) {
                                    g.text = A.getAttribute("xlink:href");
                                    break
                                }
                    ...
                    var o = this, s = t.concat(e).concat(r);
                    if (0 === s.length) return [];
                    var a = new MutationSummary.NodeMap, u = {};
                    ...
                    s.forEach(function (t) {
                        if (t && 1 !== i[t.tagName]) {
                            ...
                            if (e && !u[a.nodeId(e)] && "undefined" != typeof e.getAttribute) {
                                var r = e.getAttribute("id"), n = e.getAttribute("class"), o = t.getAttribute("class");
                                if (!r || -1 === r.toLowerCase().indexOf("clock") && -1 === r.toLowerCase().indexOf("countdown") && -1 === r.toLowerCase().indexOf("time")) if (!n || -1 === n.toLowerCase().indexOf("clock") && -1 === n.toLowerCase().indexOf("countdown") && -1 === n.toLowerCase().indexOf("time")) if (e.getAttribute("data-countdown")) ; else if (o && -1 !== o.indexOf("daterangepicker")) ; else if (t.hasAttribute("growing-ignore") || t.hasAttribute("data-growing-ignore")) ; else {
                    ...
                    return c.forEach(function (t) {
                        ...
                        if (r && "BODY" !== r.tagName) {
                            var i = r.parentNode;
                            if (null == i) return;
                            for (var s = 1, a = i.childNodes[s - 1]; s <= i.childNodes.length; s++) if (a.tagName === r.tagName && a === r) {
                                e = s;
                                break
                            }
                        }
                    ...
                    var e = this, r = [], i = new MutationSummary.NodeMap;
                    return t.forEach(function (t) {
                        var r = i.get(t);
                    ...
                    var e = this, r = t[0], i = r.added, n = t[1];
                    (!window.vds.impCtrlDua || window.vds.impCtrlDua && Date.now() - window.grImpCtrl <= window.vds.impCtrlDua) && setTimeout(function () {
                        ...
                        if (r && r.length > 0) {
                            ...
                            if (o && o.length > 0) for (var s = 0; s < o.length; s++) {
                                var a = o[s];
        ...
        r.Client = c
    }, {"./mutation-summary": 22}], 25: [function (t, e, r) {
        var i, n, o, s, a = function (t, e) {
            function r() {
                this.constructor = t
            }
    ...
    }, {"../../core/info/dom_info": 10, "./gr_user_info": 26}], 26: [function (t, e, r) {
        var i, n, o = function (t, e) {
            function r() {
                this.constructor = t
            }
        ...
        i = t("../../core/info/gr_user_info"), n = function (t) {
            ...
            return o(e, t), e.prototype.duration10year = 31536e4, e.prototype.duration30min = 1800, e.prototype.duration15min = 9e5, e.prototype.duration1min = 6e4, e.prototype.cookieDomain = function () {
                ...
                var i, n, o, s;
                for (null == r && (r = window.vds.accountId), o = this.cookie.keys(), i = 0, s = o.length; s > i; i++) if (n = o[i], n.match(/.*_gr_session_id_/) && n.slice(n.lastIndexOf("_") + 1) !== e) {
    ...
    }, {"../../core/info/gr_user_info": 11}], 27: [function (t, e, r) {
        var i, n, o, s, a, u, c, d, h = function (t, e) {
            return function () {
                return t.apply(e, arguments)
            }
        ...
        n = t("./observer/dom_observer"), s = t("./sender"), i = t("../core/base_launcher"), u = t("./info/dom_info"), d = t("../core/tools/utils"), a = d.detectIE() || 0 / 0, c = void 0, 9 > a || (window.MutationObserver = t("mutation-observer"), c = t("tree-mirror")), o = function (t) {
            ...
            return l(e, t), e.prototype.afterInitialize = function () {
    ...
    }, {"../core/tools/utils": 18, "../core/vendor/shim": 23, "./launcher": 27}], 29: [function (t, e, r) {
        ...
        i = t("../../core/observer/dom_observer"), s = t("../info/dom_info"), o = t("./server_imp_setting"), a = t("../../core/tools/utils.coffee"), n = function (t) {
            ...
            return u(e, t), e.prototype.snapshotCallback = function (t, e) {
    ...
    }, {"../../core/tools/local_store": 17, "../../core/tools/utils": 18, cookie: 19}], 31: [function (t, e, r) {
        ...
        u = t("lzstring"), h = t("../core/tools/utils"), s = h.detectIE() || 0 / 0, c = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./), o = c ? parseInt(c[2], 10) : !1, a = !1, o && 22 > o ? i = !1 : (i = !0, d = navigator.userAgent, "ArrayBufferView" in window || (-1 !== d.indexOf("Android") ? i = !1 : -1 !== d.indexOf("CPU OS ") ? -1 !== d.indexOf("CPU OS 6_") ? i = !1 : -1 !== d.indexOf("CPU OS 5_") ? i = !1 : -1 !== d.indexOf("CPU OS 4_") ? i = !1 : -1 !== d.indexOf("CPU OS 3_") && (i = !1) : -1 !== d.indexOf("CPU iPhone OS ") ? -1 !== d.indexOf("iPhone OS 6_") ? i = !1 : -1 !== d.indexOf("iPhone OS 5_") ? i = !1 : -1 !== d.indexOf("iPhone OS 4_") && (i = !1) : -1 !== d.indexOf("Intel Mac OS X") && (-1 !== d.indexOf("Mac OS X 10_6") ? i = !1 : -1 !== d.indexOf("Mac OS X 10_7") && (i = !1)))), n = function () {
            ...
            return r = [], e = [], t.prototype.sendVisitTimeout = 0, t.prototype.setUrlMap = function (t) {
                ...
                var r, i, n, o, s;
                try {
                    if (Array.isArray(t)) for (n = 0, o = t.length; o > n; n++) i = t[n], p.call(this.typeListAccepted, i) >= 0 && this.typeListReceivedValid.push(i); else {
    ...
    }, {"../core/tools/utils": 18, lzstring: 21}]
}, {}, [28]);